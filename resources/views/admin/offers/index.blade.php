                            ...
                            <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">
                                ...
                                @foreach($offers as $offer)
                                    <tr>
                                        ...
                                        <td>{{$offer->color_id}}</td>

                                        <td><a href="{{route('offer.edit',['offer'=>$offer->id])}}" class="btn btn-primary"> edit</a></td>
                                        <form method="post" action="{{route('offer.destroy',['offer'=>$offer->id])}}">
                                            @csrf
                                            @method('delete')
