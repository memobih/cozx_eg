                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                                <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-md-12">
                                        <label class="form-label">Product Describtion</label><br>
                                        <div id="editor">
                                            <input type="text" value="{{old('description')}}"   name="description" class="form-control" placeholder="Enter Product Description Here">
                                        </div>
                                        <br>
                                        @error('description')
                                        <span style="color:red">{{$message}}</span>
